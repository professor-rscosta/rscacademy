      ...
      <div style={{
        ...
        <div style={{ display:'flex', alignItems:'center', gap:12 }}>
          ...
          <div>
            <div style={{ fontSize: 13, fontWeight: 700, color: 'white', letterSpacing: '-.3px' }}>
              RSC Academy <span style={{ color: '#10b981', fontSize: 11, fontWeight: 500 }}>v1.27</span>
            </div>
        ...
        <div style={{ display:'flex', flexDirection:'column', alignItems:'flex-end', gap:8 }}>
          ...
          <div style={{ display:'flex', gap:10 }}>
            ...
            <a href="https://rscosta.rscacademy.com.br/" target="_blank" rel="noopener noreferrer"
              style={{
                width: 34, height: 34,
