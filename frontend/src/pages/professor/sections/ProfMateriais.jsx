...
var PROF_CATS = [
  ...
  { key:'videos',    label:'Videoaulas',       Icon:IcoVideoIco, cor:'#dc2626', bg:'#fef2f2', tipos:['youtube'],         desc:'Videoaulas e conteudos audiovisuais' },
  { key:'links',     label:'Referencias Complementares',  Icon:IcoLinkIco,  cor:'#0284c7', bg:'#f0f9ff', tipos:['link'],            desc:'Artigos, sites e leituras recomendadas' },
  { key:'textos',    label:'Anotacoes da Aula',        Icon:IcoTextIco,  cor:'#0f766e', bg:'#f0fdfa', tipos:['texto'],           desc:'Resumos e anotacoes de apoio ao estudo' },
];
var TIPO_CFG_PROF = {
